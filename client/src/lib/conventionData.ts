...
const standardAmerican: Convention = {
  ...
  description: 'Standard American Yellow Card — the most common convention in North America. 5-card majors, strong NT (15-17), strong 2♣.',
  rules: [
...
const twoOverOne: Convention = {
  ...
  description: '2/1 Game Forcing system. Similar to SAYC but with 1NT forcing response. 5-card majors, 15-17 NT, strong 2♣.',
  rules: [
    // Strong 2C
    {
      bid: '2C',
...
const precision: Convention = {
  id: 'precision',
  name: 'Precision Club',
  description: 'Precision Club system. 1♣ is artificial showing 16+ HCP. 1♦ is catch-all 11-15. 1NT is 13-15 balanced.',
  rules: [
...
const acol: Convention = {
  id: 'acol',
  name: 'Acol',
  description: 'Modern Acol with three weak twos. 4-card majors, weak NT (12-14), strong 2♣ (23+). The dominant system in British tournament play.',
  rules: [
