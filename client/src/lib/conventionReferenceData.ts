...
export const conventionRefs: ConventionRef[] = [
  {
    ...
    openingBids: [
      {
        bid: "1♣",
        hcp: "12–21",
        description: "3+ clubs (open with 4-4 minors if diamonds < 4)",
      },
      {
        bid: "1♦",
        hcp: "12–21",
        description: "4+ diamonds (or 4-4-3-2 with 4♦)",
      },
      { bid: "1♥", hcp: "12–21", description: "5+ hearts" },
      {
        bid: "1♠",
        hcp: "12–21",
        description: "5+ spades (bid higher suit first with 5-5)",
      },
      {
        bid: "1NT",
        hcp: "15–17",
        description: "Balanced (may include 5-card minor)",
      },
      ...
      { bid: "2NT", hcp: "20–21", description: "Balanced" },
      {
        bid: "3x",
        hcp: "5–10",
        description: "Preempt — 7-card suit (Rule of 2/3/4)",
      },
    ...
    keyConventions: [
      { name: "Stayman", description: "2♣ over 1NT asks for 4-card major." },
      {
        ...
        description: "2♦ → hearts, 2♥ → spades (over 1NT).",
      },
      {
        name: "Jacoby 2NT",
        description:
          "Game-forcing raise of partner's major (13+ HCP, 4+ support).",
      },
      {
        name: "Blackwood",
      ...
      { name: "Gerber", description: "4♣ asks for aces (over NT openings)." },
      {
        ...
        description:
          "Takeout double by responder after opponent overcall (up to 2♠).",
      },
    ],
  },
  {
    ...
    openingBids: [
      ...
      { bid: "1NT", hcp: "15–17", description: "Balanced (same as SAYC)" },
      {
        bid: "2♣",
        hcp: "22+",
        description: "Artificial, strong, forcing (same as SAYC)",
      },
      {
        bid: "2♦/♥/♠",
        hcp: "5–11",
        description: "Weak two — 6-card suit (same as SAYC)",
      },
      { bid: "2NT", hcp: "20–21", description: "Balanced (same as SAYC)" },
      {
        bid: "3x",
        hcp: "5–10",
        description: "Preempt — 7-card suit (same as SAYC)",
      },
    ],
    keyRules: [
    ...
    keyConventions: [
      {
        name: "Forcing 1NT",
        description:
          "Response to 1♥/1♠ is forcing one round; used for weaker hands or hands with long lower suits.",
      },
      {
        name: "Bergen Raises",
        description:
          "3♣ = 4+ support, 7–9 pts; 3♦ = 4+ support, 10–12 pts (over major).",
      },
      {
        name: "Inverted Minors",
        description:
          "Single raise of minor = strong/forcing; jump raise = weak/preemptive.",
      },
      {
        name: "Jacoby 2NT",
        description: "Game-forcing raise of major (13+ HCP, 4+ support).",
      },
      {
        name: "Splinter Bids",
        description:
          "Double-jump shift = game-forcing raise with singleton/void in bid suit.",
      },
      {
        name: "New Minor Forcing",
        description:
          "After 1m-1M-1NT, bid of other minor is artificial and forcing.",
      },
    ],
    differences: [
  ...
  },
  {
    ...
    name: "Precision Club",
    tagline:
      "Strong club system — 1♣ shows 16+ HCP, all other openings are limited.",
    ...
    openingBids: [
      {
        bid: "1♣",
        hcp: "16+",
        description: "ARTIFICIAL — any distribution, strong forcing",
      },
      {
        bid: "1♦",
        hcp: "11–15",
        description:
          "Catch-all: 2+ diamonds, no 5-card major, not balanced 13–15",
      },
      ...
      { bid: "1NT", hcp: "13–15", description: "Balanced, no 5-card major" },
      {
        bid: "2♣",
        hcp: "11–15",
        description: "6+ clubs (or 5♣ + 4-card major)",
      },
      {
        bid: "2♦",
        hcp: "11–15",
        description: "Short ♦: 4-4-1-4 or 4-4-0-5 shape",
      },
      {
        bid: "2♥/♠",
        hcp: "6–10",
        description: "Weak two — good 6-card suit",
      },
      ...
      { bid: "3x", hcp: "5–10", description: "Preempt — 7-card suit" },
      {
        bid: "3NT",
        hcp: "~10",
        description: "Gambling — solid 7-card minor (AKQ), little outside",
      },
    ],
    keyRules: [
    ...
    keyConventions: [
      {
        name: "1♣ Negative (1♦)",
        description: "0–7 HCP response; all other responses are positive (8+).",
      },
      {
        name: "1♣ Positive Responses",
        description:
          "1♥/1♠/2♣/2♦ = 8+ HCP, 5+ card suit; 1NT = 8–10 balanced.",
      },
      {
        name: "Precision 2♦",
        description:
          "Shows 4-4 in majors with short diamonds (4-4-1-4 or 4-4-0-5).",
      },
      {
        name: "Gambling 3NT",
        description:
          "Solid 7-card minor headed by AKQ, minimal outside values.",
      },
      {
        name: "Unusual 2NT",
        description: "5-5 in minors, 6–12 HCP (not a balanced strong hand).",
      },
    ],
    differences: [
  ...
  },
  {
    ...
    name: "Acol",
    tagline:
      "The British standard — 4-card majors, weak NT (12-14), three weak twos.",
    ...
    openingBids: [
      {
        bid: "1♣",
        hcp: "12–22",
        description: "Longer clubs (no 4-card major, clubs > diamonds)",
      },
      {
        bid: "1♦",
        hcp: "12–22",
        description: "Longer or equal diamonds (no 4-card major)",
      },
      { bid: "1♥", hcp: "12–22", description: "4+ hearts" },
      {
        bid: "1♠",
        hcp: "12–22",
        description: "4+ spades (bid higher suit first with 4-4)",
      },
      { bid: "1NT", hcp: "12–14", description: "Balanced, no 4-card major" },
      {
        bid: "2♣",
        hcp: "23+",
        description: "Artificial, strong, game-forcing",
      },
    ...
    keyConventions: [
      ...
      {
        name: "Transfers",
        description: "Commonly used over 1NT (2♦ → hearts, 2♥ → spades).",
      },
      { name: "Blackwood", description: "4NT asks for aces." },
      {
        name: "Baron 2♣",
        description: "Over 2NT opening, asks opener to bid lowest 4-card suit.",
      },
    ],
    differences: [
