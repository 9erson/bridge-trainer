    ...
    <div className="space-y-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <TabsList className="w-full grid grid-cols-3">
          <TabsTrigger value="sayc" className="text-xs sm:text-sm">
            SAYC
          </TabsTrigger>
          <TabsTrigger value="2over1" className="text-xs sm:text-sm">
            2/1 GF
          </TabsTrigger>
          <TabsTrigger value="precision" className="text-xs sm:text-sm">
            Precision
          </TabsTrigger>
        </TabsList>
          ...
          <CardContent className="pt-0">
            <div className="space-y-1">
              {convention.differences.map((diff, i) => (
                <p
                  key={i}
                  className={`text-sm ${i % 2 === 0 ? "text-muted-foreground" : "text-foreground font-medium"}`}
                >
                  {diff}
                </p>
              ))}
